...
public class userpassword extends JInternalFrame implements ActionListener{
...
userpassword(String name1){
  ...
  pn =new JPanel();
  lb4 =new JLabel("User Change Password");
...
public void actionPerformed(ActionEvent e)
{
      try
      {
          ...
          {
              // verify the password
              String verify ="SELECT * FROM employee WHERE userid ='"+user+"' AND password ='"+op1.getText()+"'";
              ...
              if(rs.next())
              {
                  if(np1.getText().equals(np2.getText()))
                  {
                      if(!np1.getText().equals(op1.getText()))
                      {
                          ...
                          String update ="UPDATE employee set password='"+np1.getText()+"' WHERE userid ='"+user+"'";
